#!/usr/bin/env bash
#==============================================================================
# run.sh - reproduce a data-skew straggler and fix it with salting. Builds a
#          skewed dataset (one hot key), shows the busiest task's row count for
#          a naive GROUP BY, then salts the hot key and shows the load drop -
#          for the identical aggregation result.
...
exec .venv/bin/python skew_salting.py
