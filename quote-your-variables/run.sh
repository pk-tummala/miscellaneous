...
# Runs anywhere (bash only). Safe: everything happens in a throwaway temp dir. Idempotent.
#==============================================================================
set -o pipefail
...
# clearer: call directly
b(){ count $@; }; g(){ count "$@"; }
printf '  $@    -> '; b "Q3 report.csv" "April data.csv"
printf '  "$@"  -> '; g "Q3 report.csv" "April data.csv"
